...
public class MySqlDataStoreUtilities {
    ...
    public static HashMap<Date, Matches> getCityMatches(String matchcity, String game) {
        HashMap<Date, Matches> hm = new HashMap<Date, Matches>();
        try {
            getConnection();

            String selectMatches = "select * from  matchlist where matchCity=? and matchCategory=?;";
    ...
    public static HashMap<Date, Matches> getTeamMatches(String team) {
        HashMap<Date, Matches> hm = new HashMap<Date, Matches>();
        try {
            getConnection();
