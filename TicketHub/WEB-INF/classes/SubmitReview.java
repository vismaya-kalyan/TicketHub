	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!utility.isLoggedin()){
			...
			return;
				...
				//Getting the extra parameters needed for the review
				String userid=request.getParameter("userid");
				String retailerstate = request.getParameter("retailerstate");
				// String manufaturerebate=request.getParameter("manufacturerebate");
				// String productonsale=request.getParameter("productonsale");
				String usergender=request.getParameter("usergender");
				String useroccupation=request.getParameter("useroccupation");
				// String productretailer=request.getParameter("productretailer");

		String message=utility.storeReview(reviewrating,reviewdate,reviewtext,retailerpin,retailercity,retailerstate,usergender,useroccupation);				     
		...
		pw.print("</h2><div class='entry'>");
      		...
      		pw.print("<h2>Review for &nbsp"+userid+" Stored </h2>");
                else
