...
public class Utilities extends HttpServlet {
	...
	public void printHtml(String file) {
		...
		if (file == "Header.html") {
			result = result + "<div id='menu' style='float: right;'>";
	...
	public String storeReview(String reviewrating,String reviewdate,String  reviewtext,String reatilerpin,String city,
	String retailerstate,String usergender,String useroccupation){
		String message=MongoDBDataStoreUtilities.insertReview(username(),reviewrating,reviewdate,reviewtext,reatilerpin,city,
		retailerstate,usergender,useroccupation);
			...
			if(!reviews.containsKey(username())){	
				...
				reviews.put(username(), arr);
			}
			ArrayList<Review> listReview = reviews.get(username());		
			Review review = new Review(username(),reviewrating,reviewdate,reviewtext,reatilerpin,city);
