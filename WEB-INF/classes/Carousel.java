	...
	public String carouselfeature(Utilities utility) {
		...
		for (OrderItem oi : utility.getCustomerOrders()) {
			if (hm.containsKey(oi.getName())) {
				System.out.println("oi" + oi.getName());
				...
				for (Map.Entry<String, String> acc : laptop1.getAccessories().entrySet()) {
					...
					if (k == 0) {
						...
						sb.append(
								"<div class='item active'><div class='col-md-6' style = 'background-color: #333;border :1px solid #cfd1d3'>");
					} else {
						sb.append(
								"<div class='item'><div class='col-md-6' style = 'background-color: #333;border :1px solid #cfd1d3' >");
					}
					...
					sb.append(
							"<li><form method='post' action='WriteReview'>" + "<input type='hidden' name='name' value='"
									+ acc + "'>" + "<input type='hidden' name='type' value='accessories'>"
									+ "<input type='hidden' name='maker' value='" + CategoryName + "'>"
									+ "<input type='hidden' name='access' value='" + oi.getName() + "'>"
									+ "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
					sb.append(
							"<li><form method='post' action='ViewReview'>" + "<input type='hidden' name='name' value='"
									+ acc + "'>" + "<input type='hidden' name='type' value='accessories'>"
									+ "<input type='hidden' name='maker' value='" + CategoryName + "'>"
									+ "<input type='hidden' name='access' value='" + oi.getName() + "'>"
				...
				sb.append("<a class='left carousel-control' href='#" + myCarousel
						+ "' data-slide='prev' style = 'width : 10% ;background-color:black; opacity :.4'>"
				...
				sb.append("<a class='right carousel-control' href='#" + myCarousel
						+ "' data-slide='next' style = 'width : 10% ;background-color:black; opacity :.4'>"
