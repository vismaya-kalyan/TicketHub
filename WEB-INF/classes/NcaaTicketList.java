...
@WebServlet("/NcaaTicketList")

public class NcaaTicketList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("ncaaid"));
        ...
        pw.print("<a style='font-size: 24px;'>NCAA Listings</a>");
